...
CSSKutusu('http://'.$_SERVER["HTTP_HOST"].'/phpwaf/veri/css/style.css');  
CSSKutusu('http://'.$_SERVER["HTTP_HOST"].'/phpwaf/veri/css/main.css');
...
CSSKutusu('http://'.$_SERVER["HTTP_HOST"].'/phpwaf/veri/css/bootstrap.css'); 
//JS Girisi
JSKutusu('http://'.$_SERVER["HTTP_HOST"].'/phpwaf/veri/js/jquery-1.11.3.min.js');
